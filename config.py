...
class BaseConfig(object):
    ...
    # SQLITE
    SQLALCHEMY_DATABASE_URI = 'sqlite:///%s' % (os.path.join(PROJECT_ROOT, "cloud.db"))
    ...
    SWAGGER_UI_OAUTH_REALM = "Authentication for Core Cloud Backend Documentation"
    SWAGGER_UI_OAUTH_APP_NAME = "Core Cloud Backend"
